...
const CreateForm: React.FC<CreateFormProps> = ({ }) => {
    ...
    return ( 
        <View style={{ flex: 1, marginHorizontal: 20, marginTop: 20}}>
            ...
            <CustomTextInput inputValue={question}
            onChangeTxt={setQuestion}
              />
            <View  style={{ backgroundColor: 'transparent', height: 10}} />

<CustomTitleText TextData="Choices" />
            <View  style={{ backgroundColor: 'transparent', height: 10}} />
            <CustomTextInput inputValue={choices}
            onChangeTxt={setChoices}
              />
...
<CustomTitleText TextData="Answer" />
            <View  style={{ backgroundColor: 'transparent', height: 10}} />
            <CustomTextInput inputValue={answer}
            onChangeTxt={setAnswer}
              />
            <View  style={{ backgroundColor: 'transparent', height: 10}} />
            <TouchableOpacity>
                <View style={{ backgroundColor: 'blue',paddingVertical: 10, borderRadius: 8, alignItems: 'center'}}>
            ...
            <TouchableOpacity onPress={() => {navigation.goBack()}}>
                <View style={{ backgroundColor: 'grey',paddingVertical: 10, borderRadius: 8, alignItems: 'center'}}>
